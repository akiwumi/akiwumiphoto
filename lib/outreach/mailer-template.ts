...
<tr><td class="pad" style="padding-bottom:38px"><table role="presentation" width="100%"><tr><td class="stack stack-pad" width="50%" valign="top" style="padding-right:9px"><img src="https://www.akiwumiphoto.com/images/intro-background.jpg" width="253" alt="Running For President — photograph by Eugene Akiwumi" style="width:100%;height:auto"><div class="eyebrow muted" style="padding-top:11px">Running For President</div></td><td class="stack" width="50%" valign="top" style="padding-left:9px"><img src="https://www.akiwumiphoto.com/images/intro-background.jpg" width="253" alt="The Political Clown — documentary photograph by Eugene Akiwumi" style="width:100%;height:auto"><div class="eyebrow muted" style="padding-top:11px">The Political Clown</div></td></tr></table></td></tr>
