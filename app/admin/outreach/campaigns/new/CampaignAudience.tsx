...
export default function CampaignAudience({ contacts: initialContacts, mailerHtml }: { contacts: AddressBookContact[]; mailerHtml: string }) {
  ...
  const visibleContacts = campaignAudienceForCountries(contacts, selectedCountries);
