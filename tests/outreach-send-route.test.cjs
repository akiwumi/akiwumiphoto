...
function request() {
  return new Request('https://example.com/api/admin/outreach/campaigns/local/send-test', {
    ...
    body: JSON.stringify({
      campaignId: 'campaign-1', contactId: 'contact-1', name: 'Ada Lovelace', studio: 'Analytical Engines',
      country: 'Sweden', website: 'https://example.com', to: 'ada@example.com', subject: 'Hello', html: '<p>Hello</p>', text: 'Hello',
    }),
  });
}
